...
<body class="gray-bg">
    ...
    <!-- ECharts -->
    <script src="/static/admin/weixin/js/plugins/echarts/echarts-all.js"></script>

    <!-- 自定义js -->
    <script src="/static/admin/weixin/js/content.js?v=1.0.0"></script>


    <!-- ECharts demo data -->
    <script src="/static/admin/weixin/js/demo/echarts-demo.js"></script>
