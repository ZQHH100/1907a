...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="/static/admin/weixin/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="/static/admin/weixin/css/font-awesome.css?v=4.4.0" rel="stylesheet">

    <link href="/static/admin/weixin/css/animate.css" rel="stylesheet">
    <link href="/static/admin/weixin/css/style.css?v=4.1.0" rel="stylesheet">
...
<body class="gray-bg">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="project-people">
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/static/admin/weixin/img/a3.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/static/admin/weixin/img/a1.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/static/admin/weixin/img/a2.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/static/admin/weixin/img/a4.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/static/admin/weixin/img/a5.jpg"></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="project-people">
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/static/admin/weixin/img/a7.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/static/admin/weixin/img/a6.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/static/admin/weixin/img/a3.jpg"></a>
                                                </td>
                                                <td class="project-actions">
                                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
    ...
    <!-- 全局js -->
    <script src="/static/admin/weixin/js/jquery.min.js?v=2.1.4"></script>
    <script src="/static/admin/weixin/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="/static/admin/weixin/js/plugins/layer/layer.min.js"></script>
    <!-- Flot -->
    <script src="/static/admin/weixin/js/plugins/flot/jquery.flot.js"></script>
    <script src="/static/admin/weixin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/static/admin/weixin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/static/admin/weixin/js/plugins/flot/jquery.flot.pie.js"></script>
    <!-- 自定义js -->
    <script src="/static/admin/weixin/js/content.js"></script>
    <!--flotdemo-->
